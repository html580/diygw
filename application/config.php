...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'Es[d_Hl^8VcJ@M/(X?%.gNS*YwG6)9!;&]z2<5"Q', //默认数据加密KEY
	'data_cache_key'=> 'Es[d_Hl^8VcJ@M/(X?%.gNS*YwG6)9!;&]z2<5"Q',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'Es[d_Hl^8VcJ@M/(X?%.gNS*YwG6)9!;&]z2<5"Q', //加密KEY
