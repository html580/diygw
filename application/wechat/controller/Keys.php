...
{
    public $formSuccessUrl='keys/index';
    /**
     * 指定当前数据表
     * @var string
     */
    ...
    public function index()
    {
        ...
        // 显示关键字列表
        $this->title = '微信关键字管理';
        $db = Db::name($this->table)->where('mpid', $this->mpid)->whereNotIn('keys', ['subscribe', 'default']);
    ...
    {
        $this->title = '添加关键字规则';
        return $this->_form($this->table, 'form',null,['mpid'=>$this->mpid],['mpid'=>$this->mpid]);
    }
    ...
    public function subscribe()
    {
        ...
        return $this->_form($this->table, 'form', 'keys',['mpid'=>$this->mpid], ['keys' => 'subscribe','mpid'=>$this->mpid]);
    }
    ...
    public function defaults()
    {
        ...
        return $this->_form($this->table, 'form', 'keys', ['mpid'=>$this->mpid], ['keys' => 'default','mpid'=>$this->mpid]);
    }
    ...
    protected function _form_filter(array &$data)
    {
        if ($this->request->isPost() && isset($data['keys'])) {
            $db = Db::name($this->table)->where('mpid', $this->mpid)->where('keys', $data['keys']);
