...
(function () {
    ...
    function initTabs() {
        ...
        selectOneImage = editor.getOpt("selectOneImage")||false;
        ...
        initEvents: function () {
            ...
            domUtils.on(this.container, 'click', function (e) {
                ...
                if (li.tagName.toLowerCase() == 'li') {
                	//console.log(selectOneImage);
                	if(selectOneImage && "undefined" != typeof $){
            ...
            $("#imageList").on("mouseenter.li","li",function(){
            	var img = $(this).find("img")[0];
            	var t = "宽："+img.naturalWidth+",高："+img.naturalHeight;
                $(this).attr({alt:t,title:t});
            });
        },
        /* 初始化第一次的数据 */
        initData: function () {
